...
# Batch response containing user configuration results with potential errors.
...
# Request body for creating a new association definition.
...
# Batch input containing an array of association specifications.
public type BatchInputPublicAssociationSpec record {
    # Array of association specifications to process in batch.
...
# Result object for an association definition configuration update.
...
# Request body for updating an association definition configuration.
...
# Request body for creating an association definition configuration.
...
# Response object containing results from a batch association configuration operation.
public type BatchResponsePublicAssociationDefinitionUserConfiguration record {
    ...
    record {|string...;|} links?;
    # Array of user configuration results from the batch operation.
    PublicAssociationDefinitionUserConfiguration[] results;
...
# Defines an association type specification with category and unique type identifier.
