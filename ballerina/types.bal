...
public type BatchInputPublicAssociationSpec record {
    # Array of association specifications to process in the batch operation.
...
# Request payload for creating an association definition configuration.
...
# Request object for updating an association definition with label and inverse label.
...
# Detailed error information including message, code, and contextual data.
...
public type CollectionResponseAssociationSpecWithLabelNoPaging record {
    # Array of association specifications with their labels.
...
# Batch response containing user configuration results for association definitions.
public type BatchResponsePublicAssociationDefinitionUserConfiguration record {
    ...
    record {|string...;|} links?;
    # Array of user configuration results for association definitions.
    PublicAssociationDefinitionUserConfiguration[] results;
...
# Batch input containing multiple association definition configuration update requests.
public type BatchInputPublicAssociationDefinitionConfigurationUpdateRequest record {
    # Array of configuration update requests to process in batch.
...
# Batch response for configuration updates including results and any errors encountered.
public type BatchResponsePublicAssociationDefinitionConfigurationUpdateResultWithErrors record {
    ...
    record {|string...;|} links?;
    # Array of successful configuration update results.
    PublicAssociationDefinitionConfigurationUpdateResult[] results;
    # Array of errors encountered during the batch operation.
    StandardError[] errors?;
...
# Batch input containing multiple association definition configuration create requests.
public type BatchInputPublicAssociationDefinitionConfigurationCreateRequest record {
    # Array of configuration create requests to process in batch.
