...
public type BatchResponsePublicAssociationDefinitionUserConfigurationWithErrors record {
    ...
    string startedAt;
    # A map of URLs linking to related resources or documentation.
    record {|string...;|} links?;
...
# Request object for creating a new association definition with label and name.
...
# Collection response containing association definition user configurations without paging.
...
# Result object representing the outcome of an association definition configuration update.
...
# Request payload for updating an existing association definition between CRM records.
...
# User-configurable settings for an association definition between CRM objects.
...
# Batch request payload for updating multiple association definition configurations.
...
# Batch response containing update results and any errors encountered during processing.
