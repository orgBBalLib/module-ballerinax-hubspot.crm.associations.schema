...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer relationship management (CRM) platform that helps businesses grow better by providing tools for marketing, sales, customer service, and content management all in one place.
...
2. If you intend to use private apps for API access, note that creating private apps requires a HubSpot account with Super Admin permissions. Additionally, certain API features may require a Professional or Enterprise plan subscription.
