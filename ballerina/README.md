...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer relationship management (CRM) platform that helps businesses manage marketing, sales, customer service, and content management through a unified suite of tools designed to drive growth and improve customer relationships.
...
2. If you intend to use private apps for API access, note that some API features may require a Professional or Enterprise plan subscription, depending on the endpoints you need to access.
...
8. Once created, navigate to the Auth tab of your private app to find your access token. Click Show token to reveal it.
