...
[HubSpot](https://www.hubspot.com/) is a cloud-based customer platform that provides marketing, sales, content management, and customer service software to help businesses grow and manage customer relationships effectively.
...
2. If you intend to use private apps for API access, note that certain API features and scopes may require a Professional or Enterprise plan subscription, depending on the data and endpoints you need to access.
...
8. Once created, your access token will be displayed. Click Show token to reveal it, then copy the token.
...
2. [Association analytics report](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations.schema/tree/main/examples/association_analytics_report) - Illustrates how to generate analytics reports based on association schema data.
