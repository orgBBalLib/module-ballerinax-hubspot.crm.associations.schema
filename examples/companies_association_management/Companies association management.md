...
This example demonstrates how to manage HubSpot company association definitions by creating a headquarters-franchise relationship between companies, reading the association definitions, updating the labels, and then deleting the associations.

## Prerequisites

1. **HubSpot Setup**
   > Refer to the [HubSpot setup guide](https://github.com/ballerina-platform/module-ballerinax-hubspot.crm.associations.schema/tree/main/docs/setup/setup.md) to obtain OAuth2 credentials.
