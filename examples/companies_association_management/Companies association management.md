...
This example demonstrates how to manage HubSpot company association definitions by creating a headquarters-franchise relationship between companies, reading all association definitions, updating the labels, and then deleting the created associations.
